//A Simplified version Unity's NetworkLobbyManager to prevent it changing scenes on connection
...
public class BP_LobbyManager : NetworkManager 
{
    public int minPlayers = 2;
    public int maxPlayers = 4;
    public BeerPongPlayer[] lobbySlots;
    ...
    public override void OnStartServer()
    {
        ...
        {
            lobbySlots = new BeerPongPlayer[maxPlayers];    
        }
    }
    ...
    public override void OnServerDisconnect(NetworkConnection conn)
    {
        ...
        //if lobbyPlayer for this connetion has not been destroyed by now, then destroy it here
    ...
    public override void OnServerAddPlayer(NetworkConnection conn, short playerControllerId)
    {
        ...
        var newLobbyPlayer = newLobbyGameObject.GetComponent<BeerPongPlayer>();
    ...
    {
        byte slot = player.gameObject.GetComponent<BeerPongPlayer>().slot;
    ...
    {
        OnLobbyClientEnter();
        foreach (BeerPongPlayer player in lobbySlots)
        {
            if(player == null)
            {
                continue;
